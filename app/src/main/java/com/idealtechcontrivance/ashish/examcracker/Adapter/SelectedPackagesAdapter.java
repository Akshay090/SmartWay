...
public class SelectedPackagesAdapter extends RecyclerView.Adapter<SelectedPackagesAdapter.ViewHolder> {
    ...
    public SelectedPackagesAdapter(List<Package> packageList, Context context){
        super();
    ...
    @Override
    public SelectedPackagesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_vertical_packages, parent, false);
        SelectedPackagesAdapter.ViewHolder viewHolder = new SelectedPackagesAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(SelectedPackagesAdapter.ViewHolder holder, int position) {

...
import com.idealtechcontrivance.ashish.examcracker.Fragment.MyTestFullFragment;
import com.idealtechcontrivance.ashish.examcracker.Fragment.MyTestListFragment;
...
public class FreePackagesAdapter extends RecyclerView.Adapter<FreePackagesAdapter.ViewHolder> {

    private Context context;
    private List<Package> packageList;

    public FreePackagesAdapter(List<Package> packageList, Context context){
        super();
    ...
    @Override
    public FreePackagesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_horizontal_packages, parent, false);
        FreePackagesAdapter.ViewHolder viewHolder = new FreePackagesAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(FreePackagesAdapter.ViewHolder holder, int position) {
        ...
        holder.txt_buy_now.setText("Try Now");
    ...
    private void openPackageDetails(Package aPackage) {
        ...
        ((FragmentActivity) context).getSupportFragmentManager().beginTransaction()
                ...
                .replace(R.id.mainContainer, myTestListFragment)
                .commit();
    }

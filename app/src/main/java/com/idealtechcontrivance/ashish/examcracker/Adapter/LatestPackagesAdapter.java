...
public class LatestPackagesAdapter extends RecyclerView.Adapter<LatestPackagesAdapter.ViewHolder> {
    ...
    public LatestPackagesAdapter(List<Package> packageList, Context context){
        super();
    ...
    @Override
    public LatestPackagesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_horizontal_packages, parent, false);
        LatestPackagesAdapter.ViewHolder viewHolder = new LatestPackagesAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(LatestPackagesAdapter.ViewHolder holder, int position) {

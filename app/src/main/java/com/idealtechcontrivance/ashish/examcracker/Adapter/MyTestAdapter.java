...
public class MyTestAdapter extends RecyclerView.Adapter<MyTestAdapter.ViewHolder> {
    ...
    public MyTestAdapter(List<Package> packageList, Context context){
        super();
    ...
    public MyTestAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyTestAdapter.ViewHolder viewHolder = new MyTestAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(MyTestAdapter.ViewHolder holder, int position) {
